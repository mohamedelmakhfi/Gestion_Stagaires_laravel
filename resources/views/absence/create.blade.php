...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Marquer l'absence</h1>
            </div>
                        ...
                        <div class="container">
                            ...
                            <form method="POST" action="{{ route('absence.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="stagiaire_id" name="stagiaire_id">
                                        @foreach ($stagiaires as $stagiaire)
                                            <option value="{{ $stagiaire->id }}">{{ $stagiaire->nom }}
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <label>
                                        <input type="radio" name="justification" value="oui" checked>
                                        oui
                                    </label>
                                    <br>
                                    <label>
                                        <input type="radio" name="justification" value="non">
                                        Non
                                    </label>
                                </div>
