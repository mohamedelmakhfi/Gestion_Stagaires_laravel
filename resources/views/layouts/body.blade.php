...
<body style="position: relative;min-height: 100vh;">
    <nav class="navbar navbar-expand-sm navbar-light shadow-sm" style="background-color: teal;">
        {{-- <i class="material-icons">person</i> --}}
        <img src="{{ asset('uploads/stagiaires/' . $stagiaire->photo) }}" width="30" class="mr-1 rounded-circle">
        <span class="navbar-brand mr-2 text-white">Bienvenue {{ $stagiaire->nom }} {{ $stagiaire->prenom }}</span>
