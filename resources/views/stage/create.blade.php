...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="app-title">
            <div>
                <h1><i class="fa fa-dashboard"></i> Affecter un stage
                </h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item"><a href="/admin-dashboard">Affecter un stage
                    </a></li>
            </ul>
        </div>
        <div class="row">
        ...
        <form action="{{ route('stage.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Note de stage:</strong>
                        <input type="text" name="note_stage" class="form-control" placeholder="note_stage">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:150px" name="appreciation" placeholder="appreciation"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Rapport de stage déposé:</strong><br>
                    <div class="form-group">
                        <label>
                            <input type="radio" name="rapport_de_stage_deposer" value="oui">
                            Oui
                        </label>
                        <label>
                            <input type="radio" name="rapport_de_stage_deposer" value="non" checked>
                            Non
                        </label>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Attestation obtenu:</strong><br>

                    <label>
                        <input type="radio" name="attestation_obtenu" value="oui">
                        Oui
                    </label>
                    <label>
                        <input type="radio" name="attestation_obtenu" value="non" checked>
                        Non
                    </label>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Projet déposé:</strong><br>
                    <label>
                        <input type="radio" name="projet_deposer" value="oui">
                        Oui
                    </label>
                    <label>
                        <input type="radio" name="projet_deposer" value="non" checked>
                        Non
                    </label>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="submit" class="btn btn-primary">Ajouter un stage </button>
            </div>
            </div>
