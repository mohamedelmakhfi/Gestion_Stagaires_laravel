...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="app-title">
            <div>
                <h1><i class="fa fa-dashboard"></i> Ajouter une tâche
                </h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item"><a href="/admin-dashboard">Ajouter une tâche
                    </a></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('tache.index') }}"> Retour</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nom_tache" class="form-control" placeholder="Nom du tâche">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
